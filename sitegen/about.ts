...
export default (doc: HTMLDocument) => {
  ...
  return div({id: "content"},
    ...
    div({style: "overflow: auto;"},
      ...
      p("Hello all,"),
      p("I'm ", Link("Tao Xin (辛韬)", "https://www.linkedin.com/in/taoxin/"), ", a senior staff software engineer at Google, and I'm the founder of ", VanJS(), ". I would like to talk about 2 central questions about ", VanJS(), ": What ", VanJS(), " really is, and why I think it's good to the world."),
