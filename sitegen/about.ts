...
export default (doc: HTMLDocument) => {
  ...
  return div({id: "content"},
    ...
    p(VanJS(), " is short for ", b("Van"), "illa ", b("J"), "ava", b("S"), "ript, which is a metaphor that ", VanJS(), " provides an abbreviated way to write Vanilla JavaScript code. Meanwhile, the logo of ", VanJS(), " is a symbolic vanilla ice cream, which means ", VanJS(), " = ", b("Vanilla"), " JavaScript + syntax ", b("Sugar"), "."),
